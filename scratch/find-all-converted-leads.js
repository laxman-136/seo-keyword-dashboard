...
async function run() {
  try {
    ...
    console.log(`\n--- All June Enrolled Leads (${juneEnrolledLeads.length}) ---`);
    juneEnrolledLeads.forEach((l, idx) => {
      ...
      console.log(`[${idx + 1}] Name: ${l.fields?.name} | Email: ${l.fields?.email} | Channel: ${channel} | Lead Date: ${leadDate} | Enroll Date: ${enrollDate} | Source Field: ${l.fields?.lead_source_1}`);
    });
