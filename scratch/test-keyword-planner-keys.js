...
async function run() {
  try {
    ...
    // Check if there is a "keywordPlanIdeas" or similar property in the keys or by checking dynamically
    const possibleServices = ['keywordPlanIdeaService', 'keywordPlanIdeas', 'keywordPlanIdea', 'generateKeywordIdeas'];
    possibleServices.forEach(srv => {
      console.log(`Has ${srv}:`, srv in customer, typeof customer[srv]);
    });
