// app/api/ads/google/campaigns/route.ts
...
export async function GET(request: Request) {
  try {
    ...
    const cacheKey = `google_campaigns_${dateRange.from}_${dateRange.to}_${dateRange.preset}_${googleCustomerId || 'default'}`
    ...
    console.error('Google Campaigns API Route error:', error)
    return NextResponse.json(
