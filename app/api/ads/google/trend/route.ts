// app/api/ads/google/trend/route.ts
...
import { fetchGoogleDailyTrend } from '@/lib/google-ads-api'
...
export async function GET(request: Request) {
  try {
    ...
    const cacheKey = `google_trend_${dateRange.from}_${dateRange.to}_${dateRange.preset}_${googleCustomerId || 'default'}`
    ...
    console.error('Google Daily Trend API Route error:', error)
    return NextResponse.json(
