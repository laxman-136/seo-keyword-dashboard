...
export async function GET(request: Request) {
  try {
    ...
    const courses = await getCourseBreakdown({ from: fromDate, to: toDate }, customToken, customEnterpriseId, bypassCache, selectedCourse)
    ...
    console.error('Leads Courses API Route error:', error)
