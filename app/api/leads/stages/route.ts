...
export async function GET(request: Request) {
  try {
    ...
    const stageCounts = await getCountByStatus({ from: fromDate, to: toDate }, customToken, customEnterpriseId, bypassCache, selectedCourse)
    ...
    console.error('Leads Stages API Route error:', error)
