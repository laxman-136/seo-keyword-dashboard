// components/revenue/RevenueQuarterOrganicPaidCard.tsx
import React from 'react'
import { RevenueQuarterlyDetailRow } from '@/lib/types'
import { formatCurrency } from '@/lib/sheets'

interface RevenueQuarterOrganicPaidCardProps {
  row: RevenueQuarterlyDetailRow
}

export default function RevenueQuarterOrganicPaidCard({ row }: RevenueQuarterOrganicPaidCardProps) {
  ...
  return (
    <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 space-y-6">
      <div>
        <h3 className="font-bold text-slate-800 text-sm">⚖️ Performance Source Comparison (Quarterly)</h3>
