// components/revenue/RevenueQuarterSelector.tsx
'use client'
import React, { useState, useRef, useEffect } from 'react'
import { Calendar, ChevronDown, Check } from 'lucide-react'
import { cn } from '@/lib/utils'

interface RevenueQuarterSelectorProps {
  quarters: string[]
  selected: string
...
export default function RevenueQuarterSelector({
  quarters,
  selected,
  onChange,
  selectedCompare,
