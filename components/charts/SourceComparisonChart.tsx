// components/charts/SourceComparisonChart.tsx
'use client';
...
interface SourceComparisonChartProps {
  sourcesA: Record<TrafficSource, number>
  sourcesB: Record<TrafficSource, number>
  labelA: string // "Period A"
  labelB: string // "Period B"
}
    ...
    <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm h-[380px] flex flex-col justify-between">
      <div>
        ...
        <p className="text-xs text-slate-400 mt-1">
          Comparing source volumes: {labelA} vs {labelB}
        </p>
      </div>
